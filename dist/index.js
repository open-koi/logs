...
class koiLogs {
    constructor(path) {
        ...
        this.middleware = middleware_1.generateKoiMiddleware(this.rawLogFileLocation);
    ...
    koiLogsHelper(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            fs.readFile(this.logFileLocation, 'utf8', (err, data) => {
                if (err) {
                    console.error(err);
    ...
    koiRawLogsHelper(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            fs.readFile(this.rawLogFileLocation, 'utf8', (err, data) => {
                if (err) {
                    console.error(err);
                    res.status(500).send(err);
                    return;
